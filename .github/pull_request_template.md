...
- **Developer Docs**: [Link to developer documentation]
...
1. **What breaks**: [Description of breaking change]
2. **Migration path**: [How users can migrate]
...
[Screenshots or descriptions of the current state]
...
[Link to demo video or GIF showing the changes]
...
- [ ] RTL (right-to-left) layout considered
...
- [ ] Offline functionality (if applicable) tested
...
1. [Any specific questions about implementation choices]
2. [Areas where you'd like feedback]
