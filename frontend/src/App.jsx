    ...
    >
      ...
      >
        <div style={cardStyle}>
          ...
          <p style={{ margin: '0 0 1.5rem 0', opacity: 0.8 }}>Track your manga reading progress</p>
          {stats && (
            <p
              style={{
                margin: '0 0 1.5rem 0',
        ...
        <div style={cardStyle}>
          ...
          <p style={{ margin: '0 0 1.5rem 0', opacity: 0.8 }}>Manage your anime watchlist</p>
          {stats && (
            <p
              style={{
                margin: '0 0 1.5rem 0',
        ...
        <div style={cardStyle}>
          ...
          <p style={{ margin: '0 0 1.5rem 0', opacity: 0.8 }}>Keep track of your reading</p>
          {stats && (
            <p
              style={{
                margin: '0 0 1.5rem 0',
      ...
      >
        ...
        <p style={{ fontSize: '0.9rem' }}>Frontend: localhost:5175 • Backend: localhost:3333</p>
      </footer>
    </div>
  );
}
