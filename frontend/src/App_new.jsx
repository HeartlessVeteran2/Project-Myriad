...
const Sidebar = ({ isOpen, onClose, theme, user }) => (
  ...
  >
    <nav>
      <a
        href='/dashboard'
        style={{ display: 'block', padding: '0.5rem', color: theme === 'dark' ? 'white' : '#333' }}
      >
        Dashboard
      </a>
      <a
    ...
    default: ({ apiStatus, apiData, stats, theme }) => (
      <div style={{ padding: '2rem' }}>
        ...
        >
          ...
          >
            <h3 style={{ margin: '0 0 1rem 0', color: theme === 'dark' ? 'white' : '#333' }}>
              📖 Manga Library
            </h3>
        ...
        {apiData && (
          ...
          >
            <h4 style={{ margin: '0 0 1rem 0', color: theme === 'dark' ? 'white' : '#333' }}>
              🔧 System Status
            </h4>
            <div
              style={{
            ...
            >
              <Suspense fallback={<LoadingSpinner />}>
                <Routes>
                  ...
                  <Route
                    path='/settings'
                    element={<Settings theme={theme} onThemeChange={toggleTheme} />}
                  />
                  <Route path='*' element={<Navigate to='/dashboard' replace />} />
                </Routes>
              </Suspense>
