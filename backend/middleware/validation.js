...
export const schemas = {
  ...
  readingProgress: Joi.object({
    ...
    status: Joi.string().valid('reading', 'completed', 'paused', 'dropped', 'plan_to_read').required(),
  ...
  search: Joi.object({
    ...
    sortBy: Joi.string().valid('relevance', 'title', 'rating', 'updated', 'created').default('relevance'),
